...
-- 音声トラック x1 (layer 20 に自動配置)
movutl.add_new_audio_track("audio_1", "../assets/audio/file_example_WAV_1MG.wav", FSTART, 20)

print("perf_test: 21 layers created (movie x10, text x5, shape x5, audio x1)")
