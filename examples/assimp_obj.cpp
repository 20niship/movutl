...
int main(int argc, char* argv[]) {
  ...
  const std::string path = (argc > 1) ? argv[1] : std::string(MOVUTL_DATA_DIR) + "/suzanne.obj";
  ...
  auto frame = mu::ui::frame("main", {
      ...
      mu::ui::collapse("object", {
        mu::ui::uivec3("pos", &obj->pos, {-10, 10}, 0.1),
        mu::ui::uivec3("dir", &obj->rotation, {-2, 2}, 0.1),
      })
  });
