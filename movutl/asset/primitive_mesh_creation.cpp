...
MU_API void add_mesh_sphere(Mesh* m, const Vec3& pos, float r, const int stack_count, const int sector_count) {
...
MU_API void add_mesh_cube(const Mesh* m, const Vec3& pos, const Vec3& size) {
  LOGE << "NOT_IMPLEMENTED!";
  exit(1);
}
MU_API void add_mesh_suzanne(const Mesh* m, const Vec3& pos, const Vec3& size) {
  LOGE << "NOT_IMPLEMENTED!";
  exit(1);
}
MU_API void add_mesh_points(const Mesh* m, const Vec3& pos, const Vec3& size) {
  LOGE << "NOT_IMPLEMENTED!";
  exit(1);
}
#endif
